    ...
    <div class="table-agile-info">
      <div class="panel panel-default">
        ...
        <tbody>
          <?php
          $i=1;
          $sql4="SELECT * FROM pegawai p INNER JOIN gaji g  b ON p.id_pegawai=b.id_pegawai INNER JOIN potongan k ON p.id_pegawai=k.id_pegawai WHERE b.tanggal LIKE '%$tgl%' AND k.tanggal LIKE '%$tgl%'";
