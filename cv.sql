...
--
-- Host: localhost:3306
-- Generation Time: Nov 28, 2019 at 08:14 PM
...
--
-- Table structure for table `anggaranperusahaan`
--
...
--
-- Dumping data for table `anggaranperusahaan`
--
...
('PSA2017', 'RK01', '2017-01-01 00:00:00', '2017', 'Y', 80000, 'apa aja disini keterangan'),
('PSA2018', 'RK02', '2018-01-02 00:00:00', '2018', 'T', 0, ''),
('PSA2019', 'RK13', '2019-11-28 00:00:00', '2019', 'Y', 199997, 'hehe');

-- --------------------------------------------------------

--
-- Table structure for table `detailanggaran`
--
...
--
-- Dumping data for table `detailanggaran`
--

INSERT INTO `detailanggaran` (`kd_anggaranperusahaan`, `kd_jenisanggaran`, `jumlahanggaranperusahaan`) VALUES
('PSA2017', 'RK01', 80000000),
('PSA2017', 'RK02', 18000000),
('PSA2017', 'RK03', 0),
('PSA2017', 'RK05', 0),
('PSA2018', 'RK01', 450759000),
('PSA2018', 'RK02', 108000000),
('PSA2018', 'RK03', 13920000),
('PSA2018', 'RK05', 11626000);
...
--
-- Table structure for table `jenisanggaran`
--
...
--
-- Dumping data for table `jenisanggaran`
--
...
('TD26', '2017-12-22 16:56:23', 'Souvenir', 0, 2000000, 23305000, 'RK01', 'PDP00000'),
...
('PDP1', 'Budget dari DISPERIN', 45000000, '2019-11-22 15:31:59', 'usr01', '2019-11-22 15:32:33'),
('PDP2', 'Modal Awal', 12500000, '2019-11-22 15:33:05', 'usr01', '2019-11-22 15:33:21'),
('PDP3', 'Budget dari DINSOS', 50000000, '2019-11-22 16:48:29', 'usr01', '2019-11-22 16:48:40');
...
--
-- Indexes for table `anggaranperusahaan`
--
...
--
-- Indexes for table `detailanggaran`
--
...
--
-- Indexes for table `jenisanggaran`
--
ALTER TABLE `jenisanggaran`
  ADD PRIMARY KEY (`kd_jenisanggaran`);

--
-- Indexes for table `kasbesar`
--
...
--
-- Constraints for table `detailanggaran`
--
ALTER TABLE `detailanggaran`
...
--
-- Constraints for table `kasbesar`
--
ALTER TABLE `kasbesar`
