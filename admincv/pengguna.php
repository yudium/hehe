                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <select class="form-control m-bot15" name="level" id="level">
                              <option value="">Pilih</option>
                              <option value="penaggungjwbkeuangan">Penaggung Jawab Administrasi & Keuangan</option>
                              <option value="pelaksanakeuangan">Pelaksana Administrasi & Keuangan</option>
							  <option value="pelaksanakeuangan">Admin</option>
                            </select>
                          </div>
                        </div>
                        <div class="form-group">
