...
if(($_SESSION['logcv']==true) && ($_SESSION['usercv']!="")){
  ...
  <script type="text/javascript">
    ...
    function validate(){
      ...
      if( MD5(lama.value) != "<?php echo $data3['password']; ?>" ){
        error = alert('password Lama Salah !');
        document.getElementById( "error_para" ).innerHTML = error;
        return false;
      }
      if( baru.value != ulang.value){
        error = alert('Kata Sandi Baru Tidak Sesuai !');
        document.getElementById( "error_para" ).innerHTML = error;
        return false;
      }else{
        return true;
              ...
              <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="" onsubmit="return validate();">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input class="form-control" id="lama" type="password" name="lama">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">Password Baru</label>
                    <div class="col-sm-6">
                      <input class="form-control" id="baru" type="password" name="baru">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">Ulang Password Baru</label>
                    <div class="col-sm-6">
                      <input class="form-control" id="ulang" type="password" name="ulang">
                    </div>
                  </div>
                  <div class="form-group">
                ...
                if (isset($_POST["submit"])){
                  ...
                  $sql2="UPDATE pengguna SET password='$baru' WHERE id_pengguna='$iduser'";
